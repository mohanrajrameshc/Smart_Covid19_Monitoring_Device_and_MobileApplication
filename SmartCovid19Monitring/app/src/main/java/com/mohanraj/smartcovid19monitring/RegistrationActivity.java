    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DateofBirth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datedialog=new DatePickerDialog(RegistrationActivity.this,mdatesetlistner,mYear,mMonth,mDay);
                datedialog.show();
            }
        });
                           ...
                           .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                               ...
                               public void onComplete(@NonNull Task<AuthResult> task) {
                                   ...
                                   if (task.isSuccessful()) {
                                       ...
                                       User user = new User(name,email,phone,aaddress,password,logintype,dob,gender);
                                       ...
                                       FirebaseDatabase.getInstance().getReference("USERS")
                                           ...
                                           public void onComplete(@NonNull Task<Void> task) {
                                               ...
                                               if (task.isSuccessful()) {
                                                   progressBar.setVisibility(View.VISIBLE);
                                                   Toast.makeText(RegistrationActivity.this,"Registred Successfull", Toast.LENGTH_LONG).show();
                                               } else {
                                                   progressBar.setVisibility(View.GONE);
                                                   Toast.makeText(RegistrationActivity.this,"Registration faild",Toast.LENGTH_LONG).show();
