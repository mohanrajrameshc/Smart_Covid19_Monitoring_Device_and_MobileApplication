...
public class UserQurantinedAdap extends FirebaseRecyclerAdapter<RealeaedAdpBean,UserQurantinedAdap.myviewholder> {
    /**
     ...
     * @param options
     */
    public UserQurantinedAdap(@NonNull FirebaseRecyclerOptions<RealeaedAdpBean> options) {
        super(options);
    }
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new UserQurantinedAdap.myviewholder(view);
    }
