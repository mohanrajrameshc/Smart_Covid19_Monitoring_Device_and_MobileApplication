...
public class QuarantinedReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quarantined_report);
        ...
        fdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datedialog=new DatePickerDialog(QuarantinedReport.this,mdatesetlistner,mYear,mMonth,mDay);
                datedialog.show();
            }
        });
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(QuarantinedReport.this,"The read failed: " + error.getCode(), Toast.LENGTH_LONG).show();
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FirebaseDatabase database = FirebaseDatabase.getInstance();
                DatabaseReference table_user = (DatabaseReference) database.getReference("QUARANTINED_LISTS");
                Query query=table_user.orderByChild("quarantineddate").startAt(fromdate).endAt(todate);
        ...
        email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(uid==null)
                {
                    ...
                    intobj.putExtra(Intent.EXTRA_SUBJECT, "Quarantined List");
