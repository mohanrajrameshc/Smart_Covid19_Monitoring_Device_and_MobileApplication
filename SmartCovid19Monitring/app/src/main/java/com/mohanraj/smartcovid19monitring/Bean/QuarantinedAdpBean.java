...
public class QuarantinedAdpBean {

    String uid,alerteddate,quarantineddate,qurantinedcenter;
    public QuarantinedAdpBean()
    {}

    public QuarantinedAdpBean(String uid, String alerteddate, String quarantineddate, String qurantinedcenter) {
        this.uid = uid;
